...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Add Type Record</a> <a href="#" class="current">Add Type Record</a> </div>
  <h1>Add Type Record</h1>
</div>
    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="{{ url('/add_type_records')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" placeholder="Enter Type Name" name="type_name" class="span11">
              </div>
            </div>
            
            <div class="form-actions">
              <input type="submit" value="Insert Type" name="submit" class="btn btn-success" />
            </div>
          </form>
        </div>
      </div>
