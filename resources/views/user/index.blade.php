...
<section class="rw-wrapper">
	...
	<!--content-->
		<div class="content">
		   ...
		   <img src="{{ asset('user_assets/images/pi.jpg') }}" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">Lorem ipsum</p><label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Trendy</h3></div></a>
					...
					<div class="col-md-6 col-md1">
						<div class="col-3">
							<a href="single.html"><img src="{{ asset('user_assets/images/pi1.jpg') }}" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Men</h5>
						...
						<div class="col-3">
							<a href="single.html"><img src="{{ asset('user_assets/images/pi2.jpg') }}" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Kids</h5>
						...
						<div class="col-3">
							<a href="single.html"><img src="{{ asset('user_assets/images/pi3.jpg') }}" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Women</h5>
			...
			<div class="content-mid">
				...
				<div class="mid-popular">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
						...
						<div class="women-top">
							...
							<div class="img item_add">
								<a href="#"><img src="{{ asset('user_assets/images/ca.png') }}" alt=""></a>
							</div>
							<div class="clearfix"></div>
							</div>
							<div class="mid-2">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc1.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc2.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc3.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc4.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc5.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc6.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="{{ asset('user_assets/images/pc7.jpg') }}" class="img-responsive" alt="">
						<div class="zoom-icon ">
			...
			<div class="brand">
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('user_assets/images/ic.png') }}" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('user_assets/images/ic1.png') }}" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('user_assets/images/ic2.png') }}" class="img-responsive" alt="">
				</div>
				<div class="col-md-3 brand-grid">
					<img src="{{ asset('user_assets/images/ic3.png') }}" class="img-responsive" alt="">
				</div>
				<div class="clearfix"></div>
			</div>
			<!--//brand-->
